  ...
  <div class="row">
    <div class="col-md-12">
	  ...
	  <h3>DATA TRANSAKSI</h3> <hr class="pg-titl-bdr-btv"></hr><br>
		...
		<form action="update_status_gudang.php?id_transaksi=<?php echo $id ?>" method="post">
			...
			<center><button type="submit" name="edit" class="btn btn-success">UPDATE STATUS</button></center>
		</form>
      </div>
	  <font color="red">*</font> Status Pesanan Dipacket Bila Telah Dikonfirmasi.<br><br>
    </div>
  </div>
</div>
